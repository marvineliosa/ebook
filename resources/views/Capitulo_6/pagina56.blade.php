  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        ...
        <div class="login-box">
          <img src="{{asset('paginas/Capitulo_6/recortes/2017PUE_PRIM_56_1.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_6/recortes/2017PUE_PRIM_56_1.JPG')}}'" style="max-width: 100%" >
          <br>
