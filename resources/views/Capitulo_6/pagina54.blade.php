...
<section class="content">
  ...
  <div class="box">
        ...
        <div class="login-box ">
          <div class="row">
            <div class="col-xs-2 col-md-2" style="background-color:white;" >
              <img src="{{asset('paginas/Capitulo6/recortes/2017PUE_PRIM_58_1.JPG')}}" class="img-fluid" style="width:190%;">
            </div>
            <div class="col-xs-10 col-md-10" style="background-color:white;">
              <br>
              <img src="{{asset('paginas/Capitulo6/recortes/2017PUE_PRIM_58_2.JPG')}}" class="img-fluid" style="width:110%;">
              ...
              <div class="has-error">
                ...
                <span clas="has-error">Me comprometo a ayudar a mi familia a decidir qué separar de los desechos para reciclarlo y qué se pueda reutilizar.</span>
                <br>
                <label class="control-label"><i class="fa fa-times-circle-o"></i></label>
                <span>Me comprometo a cuidar lo que compro para que todo, hasta el empaque, sea reutilizado o, al separarlo, pueda ser reciclado.</span>
                <br>
                <label class="control-label"><i class="fa fa-times-circle-o"></i></label>
                <span>Me comprometo a utilizar las hojas de papel por ambos lados.</span>
              </div>
              <div class="row">
                <div class="col-xs-2 col-md-2" style="background-color:white;">
              ...
              <div class="row">
                <div class="col-xs-12 col-md-12" style="background-color:white;">
                  <p class="text-blue text-center">Yo:</p>
              ...
              <br>
              <img src="{{asset('paginas/Capitulo6/recortes/2017PUE_PRIM_58_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo6/recortes/2017PUE_PRIM_58_3.JPG')}}'" style="width:110%;">
            </div>
          </div>
       </div>
      </div>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(53)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(55)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div align='center'>
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo6/familiares/Pag 58.mp3"></audio>
          <img src="{{asset('padres/Capitulo6/2017PUE_PRIM_FAM_5_58.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo6/2017PUE_PRIM_FAM_5_58.jpg')}}'"  style="max-width: 100%">
          <img src="{{asset('padres/Capitulo6/2017PUE_PRIM_FAM_5_59.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo6/2017PUE_PRIM_FAM_5_59.jpg')}}'"  style="max-width: 100%">
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo6/familiares/Pag 60.mp3"></audio>
          <img src="{{asset('padres/Capitulo6/2017PUE_PRIM_FAM_5_60.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo6/2017PUE_PRIM_FAM_5_60.jpg')}}'"  style="max-width: 100%">
        </div>
      </div>
...
@section('script')
  <script type="text/javascript">
    function siguiente(pagina)
       {
        window.location.replace('http://localhost:8000/1/7/55');
         //alert("adelante");
       }
