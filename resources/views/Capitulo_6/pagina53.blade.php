...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        <div class="login-box">
          <img src="{{asset('paginas/Capitulo6/recortes/2017PUE_PRIM_57.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo6/recortes/2017PUE_PRIM_57.JPG')}}'" style="max-width: 100%" > <!--LINEA TRABJA CON JETZOOM-->
          <br>
          <br>
          <p class="text-left"> Menciona algo que hayas aprendido sobre <code class="text-blue"><strong>La reutilización de los desechos sólidos en casa</strong></code>y explicalo con tus propias palabras:</p>
          ...
          <input type="text text-center" class="form-control" align="center" id="Entrada_Que_aprendi_del_Cuento" placeholder="Escribe aqui tu respuesta" value="{{((isset($datos->respuesta1))?$datos->respuesta1:'')}}">
          <br>
          <p class="text-left"><code class="text-red"><strong>Conclusiones</strong></code></p>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(52)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(54)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
