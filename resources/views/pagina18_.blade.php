...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        <img src="{{asset('paginas/18_.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/18_.PNG')}}'" style="max-width: 100%" > <!--LINEA TRABJA CON JETZOOM-->
      </div>
    </div>
    <!-- /.box-body -->
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(17)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(19)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
