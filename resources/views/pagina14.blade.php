...
<section class="content">
  ...
  <div class="box">
    ...
    <h3 class="box-title"><audio id="audio" controls>
          <source type="audio/wav" src="{{asset('audio/Pag 17.mp3')}}">
        </audio></h3>-->
    ...
    <div class="box-body">
      <div align='center'>
        <img src="{{asset('paginas/2017PUE_PRIM_14.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/2017PUE_PRIM_14.JPG')}}'" style="max-width: 50%" > <!--LINEA TRABJA CON JETZOOM-->
      </div>
    </div>
    <!-- /.box-body -->
