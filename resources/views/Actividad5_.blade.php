      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div align='center'>
            ...
            <div class="login-box ">
              <img src="{{asset('paginas/12.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
        ...
        <div class="btn-group">
          <button type="button" class="btn btn-default" onclick="anterior(11)"><i class="fa  fa-arrow-left"></i></button>
