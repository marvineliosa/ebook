  ...
  <div class="box">
      ...
      <div class="login-box ">
        <div class="row">
          <div class="col-xs-2 col-md-2" style="background-color:white;" >
            <img src="{{asset('paginas/Capitulo4/recortes/2017PUE_PRIM_44_1.JPG')}}" class="img-fluid" style="width:190%;">
          </div>
          <div class="col-xs-10 col-md-10" style="background-color:white;">
            <img src="{{asset('paginas/Capitulo4/recortes/2017PUE_PRIM_44_2.JPG')}}" class="img-fluid" style="width:110%;">
            ...
            <div class="has-error">
              ...
              <span clas="has-error">Me comprometo a buscar siempre la manera de reparar los daños que ocasiono o pedir ayuda a un adulto de mi confianza para hacerlo.</span>
              <br>
              <label class="control-label"><i class="fa fa-times-circle-o"></i></label>
              <span>Cuando vea a alguien dañar algo o a alguien, me comprometo a invitarlo a no hacerlo.</span>
              <br>
              <label class="control-label"><i class="fa fa-times-circle-o"></i></label>
              <span>Me comprometo a enfrentar las consecuencias de mis actos.</span>
            </div>
            <div class="row">
              <div class="col-xs-2 col-md-2" style="background-color:white;">
            ...
            <br>
            <img src="{{asset('paginas/Capitulo4/recortes/2017PUE_PRIM_44_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo4/recortes/2017PUE_PRIM_44_3.JPG')}}'" style="width:110%;">
          </div>
        </div>
     </div>
    </div>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        ...
        <button type="button" class="btn btn-default" onclick="siguiente(41)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div align='center'>
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo4/familiares/Pag 45.mp3"></audio>
          <img src="{{asset('padres/Capitulo4/2017PUE_PRIM_FAM_5_45.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo4/2017PUE_PRIM_FAM_5_45.jpg')}}'"  style="max-width: 100%">
          <img src="{{asset('padres/Capitulo4/2017PUE_PRIM_FAM_5_46.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo4/2017PUE_PRIM_FAM_5_46.jpg')}}'"  style="max-width: 100%">
        </div>
      </div>
...
@section('script')
  <script type="text/javascript">
    function siguiente(pagina)
       {
        window.location.replace('http://localhost:8000/1/5/41');
         //alert("adelante");
       }
