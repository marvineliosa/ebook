...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        <img src="{{asset('paginas/Capitulo_4/2017PUE_PRIM_38.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_4/2017PUE_PRIM_38.JPG')}}'" style="max-width: 50%" > <!--LINEA TRABJA CON JETZOOM-->
      </div>
    </div>
    <!-- /.box-body -->
  ...
  <script type="text/javascript">
    function siguiente(pagina)
     ...
     function anterior(pagina)
        {
          window.location.replace('http://localhost:8000/1/3/37');
          //alert("atras");
        }
  </script>
