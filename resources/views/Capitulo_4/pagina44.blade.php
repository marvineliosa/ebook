...
<section class="content">
  ...
  <div class="box">
        ...
        <div class="login-box ">
          <div class="row">
            <div class="col-xs-2 col-md-2" style="background-color:white;" >
              <img src="{{asset('paginas/Capitulo_4/recortes/2017PUE_PRIM_44_1.JPG')}}" class="img-fluid" style="width:190%;">
            </div>
            <div class="col-xs-10 col-md-10" style="background-color:white;">
              <img src="{{asset('paginas/Capitulo_4/recortes/2017PUE_PRIM_44_2.JPG')}}" class="img-fluid" style="width:110%;">
              ...
              <br>
              <img src="{{asset('paginas/Capitulo_4/recortes/2017PUE_PRIM_44_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_1/recortes/2017PUE_PRIM_22.JPG')}}'" style="width:110%;">
            </div>
          </div>
       </div>
        <!-------------------------------------->
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(43)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(45)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
...
@section('script')
  <script type="text/javascript">
    function siguiente(pagina)
       {
        window.location.replace('http://localhost:8000/1/5/45');
         //alert("adelante");
       }
