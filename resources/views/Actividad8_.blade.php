      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div align='center'>
            ...
            <div class="login-box ">
              <img src="{{asset('paginas/15_.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
              ...
              <br>
              <img src="{{asset('paginas/15_1.JPG')}}" class="img-fluid" style="width:100%;">
        ...
        <div class="btn-group">
          <button type="button" class="btn btn-default" onclick="anterior(14)"><i class="fa  fa-arrow-left"></i></button>
