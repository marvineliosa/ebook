      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div align='center'>
            ...
            <div class="login-box ">
              <img src="{{asset('paginas/14_.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
              <p class="text-left"> Menciona algo que aprendiste sobre <code class="text-orange "><strong>Compromiso ante la familia</strong></code>y explicalo con tus propias palabras:</p>
              ...
              <input type="text text-center" class="form-control" align="center" id="Entrada_Que_aprendi_del_Cuento" placeholder="Escribe aqui tu respuesta" value="{{((isset($datos->respuesta1))?$datos->respuesta1:'')}}">
              <br>
              <img src="{{asset('paginas/14_1.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
        ...
        <div class="btn-group">
          <button type="button" class="btn btn-default" onclick="anterior(13)"><i class="fa  fa-arrow-left"></i></button>
          <button type="button" class="btn btn-default" onclick="siguiente(15)"><i class="fa fa-arrow-right"></i></button>
        </div>
        </div>
