  ...
  <div class="box">
    <div class="box-header with-border" align="center">
      <h3 class="box-title"><audio id="audio" controls>
          <source type="audio/wav" src="{{asset('audio/Nahuatl.wav')}}">
        </audio></h3>
    ...
    <div class="box-body">
      <div align='center'>
        <!-- <img src="{{asset('paginas/p3.PNG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/p3L.PNG')}}'" style="max-width: 100%"> -->
      </div>
    </div>
    <!-- /.box-body -->
