...
<section class="content">
  ...
  <!--<h3 class="box-title"><audio id="audio" controls>
    ...
    <div class="box-body">
      <div align='center'>
        <img src="{{asset('paginas/Capitulo0/0008.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo0/0008.JPG')}}'" style="max-width: 50%" > <!--LINEA TRABJA CON JETZOOM-->
      </div>
    </div>
    <!-- /.box-body -->
