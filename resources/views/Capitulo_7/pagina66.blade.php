...
<section class="content">
  ...
  <div class="box">
      ...
      <h3 class="box-title"><audio id="audio" controls>
          <source type="audio/wav" src="{{asset('audio/alumnos/Pag_66.mp3')}}">
        </audio></h3>
        ...
        <div class="login-box ">
          <div class="row">
            <div class="col-xs-2 col-md-2" style="background-color:white;" >
              <img src="{{asset('paginas/Capitulo_7/recortes/2017PUE_PRIM_66_1.JPG')}}" class="img-fluid" style="width:190%;">
            </div>
            <div class="col-xs-10 col-md-10" style="background-color:white;">
              <br>
              <img src="{{asset('paginas/Capitulo_7/recortes/2017PUE_PRIM_66_2.JPG')}}" class="img-fluid" style="width:110%;">
              ...
              <br>
              <img src="{{asset('paginas/Capitulo_7/recortes/2017PUE_PRIM_66_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_7/recortes/2017PUE_PRIM_66_3.JPG')}}'" style="width:110%;">
            </div>
          </div>
       </div>
      </div>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(65)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(67)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
