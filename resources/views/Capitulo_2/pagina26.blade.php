...
<section class="content">
  ...
  <div class="box">
        ...
        <div class="login-box ">
          <div class="row">
            <div class="col-xs-2 col-md-2" style="background-color:white;" >
              <img src="{{asset('paginas/Capitulo2/recortes/2017PUE_PRIM_30_1.JPG')}}" class="img-fluid" style="width:190%;">
            </div>
            <div class="col-xs-10 col-md-10" style="background-color:white;">
              <br>
              <img src="{{asset('paginas/Capitulo2/recortes/2017PUE_PRIM_30_2.JPG')}}" class="img-fluid" style="width:110%;">
              ...
              <br>
              <img src="{{asset('paginas/Capitulo2/recortes/2017PUE_PRIM_30_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo2/recortes/2017PUE_PRIM_30_3.JPG')}}'" style="width:110%;">
            </div>
          </div>
       </div>
      </div>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(25)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(27)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div align='center'>
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo2/familiares/Pag 32.mp3"></audio>
          <img src="{{asset('padres/Capitulo2/2017PUE_PRIM_FAM_5_32.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo2/2017PUE_PRIM_FAM_5_32.jpg')}}'"  style="max-width: 100%">
          <img src="{{asset('padres/Capitulo2/2017PUE_PRIM_FAM_5_33.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo2/2017PUE_PRIM_FAM_5_33.jpg')}}'"  style="max-width: 100%">
        </div>
      </div>
...
@section('script')
  <script type="text/javascript">
    function siguiente(pagina)
       {
        window.location.replace('http://localhost:8000/1/3/27');
