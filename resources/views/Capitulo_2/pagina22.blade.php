      ...
      <div class="box-header with-border" align="center">
       ...
       <br>
        <h3 class="box-title"><audio id="audio" controls>
           <source type="audio/wav" src="{{asset('audio/alumnos/Pag_22.mp3')}}">
         </audio></h3>
       ...
       <!-- <div class="box-tools pull-right">
        ...
        <div class="box-body">
          <div align='center'>
              <img src="{{asset('paginas/Capitulo2/0022.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo2/0022.JPG')}}'"  style="max-width: 50%">
          </div>
        </div>
