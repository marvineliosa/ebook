    ...
    <div class="box">
        <div class="box-header with-border" align="center">
          ...
          <h3 class="box-title"><audio id="audio" controls>
              <source type="audio/wav" src="{{asset('audio/alumnos/Tema_2_pag_20.mp3')}}">
            </audio></h3>
      ...
      <div class="box-body">
        <div align='center'>
          <img src="{{asset('paginas/Capitulo2/0020.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo2/0020.JPG')}}'" style="max-width: 50%" > <!--LINEA TRABJA CON JETZOOM-->
        </div>
      </div>
