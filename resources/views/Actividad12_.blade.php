      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div align='center'>
            ...
            <div class="login-box ">
              <img src="{{asset('paginas/22_.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
              <p class="text-left"><code class="text-purple "><strong>Yo</strong></code></p>
              ...
              <p class="text-center"><code class="text-orange "><strong>Firma del alumno</strong></code></p>
              ...
              <p class="text-center"><code class="text-orange "><strong>Firma de los padres o tutores</strong></code></p>
              <br>
              ...
              <input type="text text-center" size="20" align="center" id="Entrada_Que_aprendi_del_Cuento" placeholder="Escribe aqui tu firma" value="{{((isset($datos->respuesta1))?$datos->respuesta1:'')}}">
              <input type="text text-center" size="20" align="right" id="Entrada_Que_aprendi_del_Cuento" placeholder="Escribe aqui tu firma" value="{{((isset($datos->respuesta1))?$datos->respuesta1:'')}}">
              <p class="text-center"><code class="text-orange "><strong>Firma de otros familiares</strong></code></p>
              <br>
              <img src="{{asset('paginas/22_1.JPG')}}" class="img-fluid" style="width:100%;">
        ...
        <div class="btn-group">
          <button type="button" class="btn btn-default" onclick="anterior(21)"><i class="fa  fa-arrow-left"></i></button>
          <button type="button" class="btn btn-default" onclick="siguiente(23)"><i class="fa fa-arrow-right"></i></button>
        </div>
        </div>
