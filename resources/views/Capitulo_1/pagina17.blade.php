...
<section class="content">
  ...
  <div class="box">
      ...
      <h3 class="box-title"><audio id="audio" controls>
          <source type="audio/wav" src="{{asset('audio/alumnos/Pag_17.mp3')}}">
        </audio></h3>
    ...
    <div class="box-body">
      <div align='center'>
        <div class="login-box ">
          <img src="{{asset('paginas/Capitulo1/recortes/2017PUE_PRIM_21.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo1/recortes/2017PUE_PRIM_21.JPG')}}'"  style="max-width: 100%">
          <br><br>
          <p class="text-left"> <textarea name="mensaje" id="respuesta" placeholder="Anota otras consecuencias positivas" rows="5" cols="50">{{((isset($datos->comentario_negativo))?$datos->comentario_negativo:'')}}</textarea></p>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="siguiente(16)"><i class="fa  fa-arrow-left"></i></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div align='center'>
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo1/familiares/Pag 23.mp3"></audio>
          <img src="{{asset('padres/Capitulo1/2017PUE_PRIM_FAM_5_23.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo1/2017PUE_PRIM_FAM_5_23.jpg')}}'"  style="max-width: 100%">
        </div>
      </div>
