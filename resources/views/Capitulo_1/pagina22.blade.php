       ...
       <!-- <div class="box-tools pull-right">
        ...
        <div class="box-body">
          <div align='center'>
            ...
            <div class="login-box">
              <img src="{{asset('paginas/Capitulo_1/recortes/2017PUE_PRIM_22.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_1/recortes/2017PUE_PRIM_22.JPG')}}'"  style="max-width: 100%">
              <br>
              <br>
