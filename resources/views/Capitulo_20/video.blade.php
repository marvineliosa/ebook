...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        <!-- <img src="{{asset('paginas/Capitulo_20/Pagina_167.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_20/Pagina_167.jpg')}}'" style="max-width: 50%" > -->
        <!-- <video src="{{asset('video/tema.mp4')}}"></video> -->
        <video src="{{asset('video/tema.mp4')}}" width=1080  height=720 controls poster="vistaprevia.jpg">
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(155)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(156)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
