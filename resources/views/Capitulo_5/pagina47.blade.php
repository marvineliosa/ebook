...
<section class="content-header">
  <h1>
    "Las mujeres en lo familiar, profesional y social"
...
<section class="content">
  ...
  <div class="box">
        ...
        <div class="login-box ">
          <div class="row">
            <div class="col-xs-2 col-md-2" style="background-color:white;" >
              <img src="{{asset('paginas/Capitulo5/recortes/2017PUE_PRIM_51_1.JPG')}}" class="img-fluid" style="width:190%;">
            </div>
            <div class="col-xs-10 col-md-10" style="background-color:white;">
              <img src="{{asset('paginas/Capitulo5/recortes/2017PUE_PRIM_51_2.JPG')}}" class="img-fluid" style="width:110%;">
              ...
              <div class="has-error">
                ...
                <span clas="has-error">Me comprometo a investigar más sobre el papel que juega mi mamá en mi familia.</span>
                <br>
                <label class="control-label"><i class="fa fa-times-circle-o"></i></label>
                <span>Me comprometo a promover que las niñas y los niños nos integremos en los juegos, las tareas de la escuela, las actividades deporrtivas , etcétera.</span>
                <br>
                <label class="control-label"><i class="fa fa-times-circle-o"></i></label>
                <span>Me comprometo a que niñas y niños respetemos nuestra manera de ser y de pensar.</span>
              </div>
              <br>
              <div class="row">
                <div class="col-xs-2 col-md-2" style="background-color:white;">
              ...
              <div class="row">
                <div class="col-xs-12 col-md-12" style="background-color:white;">
                  <p class="text-red text-center">Yo:</p>
              ...
              <br>
              <img src="{{asset('paginas/Capitulo5/recortes/2017PUE_PRIM_51_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo5/recortes/2017PUE_PRIM_51_3.JPG')}}'" style="width:110%;">
            </div>
          </div>
       </div>
      </div>
    ...
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="anterior(46)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(48)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div align='center'>
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo5/familiares/Pag 51.mp3"></audio>
          <img src="{{asset('padres/Capitulo5/2017PUE_PRIM_FAM_5_51.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo5/2017PUE_PRIM_FAM_5_51.jpg')}}'"  style="max-width: 100%">
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo5/familiares/Pag 52.mp3"></audio>
          <img src="{{asset('padres/Capitulo5/2017PUE_PRIM_FAM_5_52.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/Capitulo5/2017PUE_PRIM_FAM_5_52.jpg')}}'"  style="max-width: 100%">
        </div>
      </div>
...
@section('script')
  <script type="text/javascript">
    function siguiente(pagina)
       {
        window.location.replace('http://localhost:8000/1/6/48');
         //alert("adelante");
       }
