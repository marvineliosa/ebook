        ...
        <div class="login-box ">
          <div class="row">
            <div class="col-xs-2 col-md-2" style="background-color:white;" >
              <img src="{{asset('paginas/Capitulo_5/recortes/2017PUE_PRIM_51_1.JPG')}}" class="img-fluid" style="width:190%;">
            </div>
            <div class="col-xs-10 col-md-10" style="background-color:white;">
              <img src="{{asset('paginas/Capitulo_5/recortes/2017PUE_PRIM_51_2.JPG')}}" class="img-fluid" style="width:110%;">
              ...
              <br>
              <img src="{{asset('paginas/Capitulo_5/recortes/2017PUE_PRIM_51_3.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_1/recortes/2017PUE_PRIM_22.JPG')}}'" style="width:110%;">
            </div>
          </div>
       </div>
        <!-------------------------------------->
...
@section('script')
  <script type="text/javascript">
    function siguiente(pagina)
       {
        window.location.replace('http://localhost:8000/1/6/52');
         //alert("adelante");
       }
