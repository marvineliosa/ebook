      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div align='center'>
            ...
            <div class="login-box ">
              <img src="{{asset('paginas/7_.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
              <p class="text-left"> Menciona algo que hayas aprendido de <code class="text-purple "><strong>Leo, pienso y escribo 5°</strong></code>y explicalo con tus propias palabras:</p>
              ...
              <input type="text text-center" class="form-control" align="center" id="Entrada_Que_aprendi_del_Cuento" placeholder="Escribe aqui tu respuesta" value="{{((isset($datos->respuesta1))?$datos->respuesta1:'')}}">
              <br>
              <img src="{{asset('paginas/7_1.JPG')}}" class="img-fluid" style="width:100%;">
              <br>
              <br>
