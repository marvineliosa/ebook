...
<section class="content">
  ...
  <div class="box">
      ...
      <h3 class="box-title"><audio id="audio" controls>
          <source type="audio/wav" src="{{asset('audio/alumnos/Pag_29.mp3')}}">
        </audio></h3>
    ...
    <div class="box-body">
      <div align='center'>
        <img src="{{asset('paginas/Capitulo3/0029.JPG')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo3/0029.JPG')}}'" style="max-width: 50%" > <!--LINEA TRABJA CON JETZOOM-->
      </div>
    </div>
    <!-- /.box-body -->
    <div class="box-footer" align="center">
      <div class="btn-group">
        <button type="button" class="btn btn-default" onclick="siguiente(28)"><i class="fa  fa-arrow-left"></i></button>
        <button type="button" class="btn btn-default" onclick="siguiente(30)"><i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
    <!-- /.box-footer-->
  </div>
