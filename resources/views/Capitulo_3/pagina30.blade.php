...
<section class="content">
  ...
  <div class="box">
      ...
      <h3 class="box-title"><audio id="audio" controls>
          <source type="audio/wav" src="{{asset('audio/alumnos/Pag_30.mp3')}}">
        </audio></h3>
    ...
    <div class="box-body">
      <div align='center'>
        <div class="login-box">
          <img src="{{asset('paginas/Capitulo3/recortes/2017PUE_PRIM_34.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo3/recortes/2017PUE_PRIM_34.JPG')}}'"  style="max-width: 100%">
          <br>
          <br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div align='center'>
          <audio id="audio" controls=""><source type="audio/wav" src="http://127.0.0.1:8000/audio/Capitulo3/familiares/Pag 37.mp3"></audio>
