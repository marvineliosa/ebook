...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        <div class="login-box">
          <img src="{{asset('paginas/Capitulo3/recortes/2017PUE_PRIM_36_1.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo3/recortes/2017PUE_PRIM_36_1.JPG')}}'"  style="max-width: 100%">
          <br>
          <br>
          <p class="text-left"> Menciona algo que hayas aprendido sobre <code class="text-aqua "><strong>Perseverancia en los estudios</strong></code>y explicalo con tus propias palabras:</p>
