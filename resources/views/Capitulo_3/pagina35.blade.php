...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div align='center'>
        <div class="login-box">
          <img src="{{asset('paginas/Capitulo_3/recortes/2017PUE_PRIM_35.JPG')}}" class="img-fluid jetzoom" data-jetzoom ="zoomImage:'{{asset('paginas/Capitulo_3/2017PUE_PRIM_35.JPG')}}'"  style="max-width: 100%">
          <br>
          <br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div align='center'>
          <img src="{{asset('padres/Capitulo3/2017PUE_PRIM_FAM_5_38.jpg')}}" class="img-fluid jetzoom"  data-jetzoom ="zoomImage:'{{asset('padres/2017PUE_PRIM_FAM_5_38.jpg')}}'"  style="max-width: 100%">
        </div>
      </div>
