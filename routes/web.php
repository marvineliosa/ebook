...
// Capitulos 20
    ...
    Route::get('/1/20/video', function (){return view('Capitulo_20/video');});
...
//Capitulo 8
        ...
        Route::get('/1/8/64', function (){return view('Capitulo_8/pagina64');});
        Route::get('/1/8/65', function (){return view('Capitulo_8/pagina65');});

        // Route::get('/1/8/66', function (){return view('Capitulo_8/pagina66');});
...
//Capitulo 9
        ...
        Route::get('/1/9/71', function (){return view('Capitulo_9/pagina71');});
        Route::get('/1/9/72', function (){return view('Capitulo_9/pagina72');});
        Route::get('/1/9/73', function (){return view('Capitulo_9/pagina73');});
        Route::get('/1/9/74', function (){return view('Capitulo_9/pagina74');});
...
//Capitulo 10
        ...
        Route::get('/1/10/80', function (){return view('Capitulo_10/pagina80');});
        Route::get('/1/10/81', function (){return view('Capitulo_10/pagina81');});
...
//Capitulo 11
        ...
        Route::get('/1/11/86', function (){return view('Capitulo_11/pagina86');});
        Route::get('/1/11/87', function (){return view('Capitulo_11/pagina87');});
        Route::get('/1/11/88', function (){return view('Capitulo_11/pagina88');});
...
//Capitulo 12
        ...
        Route::get('/1/12/93', function (){return view('Capitulo_12/pagina93');});
        Route::get('/1/12/94', function (){return view('Capitulo_12/pagina94');});
        Route::get('/1/12/95', function (){return view('Capitulo_12/pagina95');});
        Route::get('/1/12/96', function (){return view('Capitulo_12/pagina96');});
...
//Capitulo 13
        ...
        Route::get('/1/13/101', function (){return view('Capitulo_13/pagina101');});
        Route::get('/1/13/102', function (){return view('Capitulo_13/pagina102');});
        Route::get('/1/13/103', function (){return view('Capitulo_13/pagina103');});
...
//Capitulo 14
        ...
        Route::get('/1/14/108', function (){return view('Capitulo_14/pagina108');});
        Route::get('/1/14/109', function (){return view('Capitulo_14/pagina109');});
        Route::get('/1/14/110', function (){return view('Capitulo_14/pagina110');});
...
//Capitulo 15
        ...
        Route::get('/1/15/115', function (){return view('Capitulo_15/pagina115');});
        Route::get('/1/15/116', function (){return view('Capitulo_15/pagina116');});
        Route::get('/1/15/117', function (){return view('Capitulo_15/pagina117');});
        Route::get('/1/15/118', function (){return view('Capitulo_15/pagina118');});
...
// Capitulos 8 al 15 *******************************************************************************************************
        ...
        Route::get('/1/{capitulo}/{pagina}/','PaginasController@Obtener_Comentarios');
